                ...
                .filter(
                        document("get-server-home",
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.hashTagList").type(ARRAY).description("해시태그 배열"),
                                        ...
                                        fieldWithPath("result.notice").type(OBJECT).description("공지"),
                                        ...
                                        fieldWithPath("result.chat").type(OBJECT).description("채팅"),
